...
uuidv7() {
		...
		value_6=$(printf "%02x" $((0x70 | ((_uuidv7_sequence_counter >> 12) & 0x0F)))) # Version 7 in the high 4 bits
		value_7=$(printf "%02x" $((_uuidv7_sequence_counter >> 4 & 0xFF))) # Next 8 bits of sequence counter

		# variant and sequence bits
		value_8=$(printf "%02x" $((0x80 | ((_uuidv7_sequence_counter & 0x0F))))) # Variant 10xx and last 4 bits of sequence counter

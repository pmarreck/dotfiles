...
# To run this as a webserver, you can use socat:
# socat TCP-LISTEN:8888,reuseaddr,fork SYSTEM:"/path/to/webserver.awk"

# via https://github.com/crossbowerbt/awk-webserver
...
/GET [^ ]+ HTTP/ {
	...
	gsub(/[\r\n]+/, "", request_filename) # remove cr's, lf's
